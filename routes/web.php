...
use App\Http\Controllers\ImportCSVJobController;
...
Route::post('/import-csv-job-users', [ImportCSVJobController::class, 'importCsvJobUsers'])->name('user.import-csv-job-users');